...
#include "../../downloadToDisk/loadsave.h"
...
QT_MOC_LITERAL(4, 50, 3), // "err"
QT_MOC_LITERAL(5, 54, 5), // "files"
...
void ftpload::WLoadFtp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->endLoad((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QStringList(*)>(_a[2]))); break;
