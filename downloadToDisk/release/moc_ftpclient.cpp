...
QT_MOC_LITERAL(14, 118, 10), // "commFinish"
QT_MOC_LITERAL(15, 129, 2), // "id"
QT_MOC_LITERAL(16, 132, 6), // "hasBed"
QT_MOC_LITERAL(17, 139, 10) // "functTimer"
    ...
    "urlInfo\0commFinish\0id\0hasBed\0functTimer"
};
#undef QT_MOC_LITERAL
...
void WFtpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 9: _t->commFinish((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        case 10: _t->functTimer(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
